        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-slate-500 sm:text-base">
              Cada experiencia cuenta. Comparte la tuya o descubre lo que otros clientes ya han dicho sobre nosotros.
            </p>
          </div>
              ...
              >
                ...
                <div className="grid gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        handleReferenceFieldChange("name", event.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        handleReferenceFieldChange("company", event.target.value)
                      }
                      className="w-full rounded-2xl border border-border bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#003F91] focus:ring-2 focus:ring-[#003F91]/15"
                ...
                <div className="grid gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        handleReferenceFieldChange("role", event.target.value)
                      }
                      className="w-full rounded-2xl border border-border bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#003F91] focus:ring-2 focus:ring-[#003F91]/15"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        handleReferenceFieldChange("location", event.target.value)
                      }
                      className="w-full rounded-2xl border border-border bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#003F91] focus:ring-2 focus:ring-[#003F91]/15"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      handleReferenceFieldChange("message", event.target.value)
                    }
                    className="w-full rounded-2xl border border-border bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#003F91] focus:ring-2 focus:ring-[#003F91]/15"
                    ...
                    {Array.from({ length: 5 }).map((_, index) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            handleReferenceFieldChange("rating", value)
                          }
