        ...
        <div style={{ padding: "20px 28px" }}>
          ...
          >
            ...
            >
              <div>
                ...
                <p
                  style={{ color: C.ink, fontSize: "12px", fontWeight: "500" }}
                >
                  {data.customer.name}
                </p>
              </div>
            ...
            {data.items.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "9px 12px",
                  borderBottom:
                    i < data.items.length - 1 ? `1px solid ${C.grayL}` : "none",
              ...
              >
                ...
                <p
                  style={{ color: C.ink, fontSize: "12px", textAlign: "right" }}
                >
          ...
          >
            ...
            >
              <div style={{ padding: "12px 14px" }}>
                ...
                >
                  <span style={{ color: C.grayD, fontSize: "12px" }}>
                    Subtotal
                  </span>
                  <span style={{ color: C.ink, fontSize: "12px" }}>
                ...
                {data.discount && data.discount > 0 && (
                  ...
                  >
                    <span style={{ color: C.teal, fontSize: "12px" }}>
                      Descuento
                    </span>
                    <span style={{ color: C.teal, fontSize: "12px" }}>
          ...
          {data.notes && (
            ...
            >
              ...
              <p
                style={{ color: C.grayD, fontSize: "11px", lineHeight: "1.5" }}
              >
                {data.notes}
              </p>
            </div>
